...
(0,_inertiajs_inertia_vue__WEBPACK_IMPORTED_MODULE_0__.createInertiaApp)({
  ...
  setup: function setup(_ref) {
    var el = _ref.el,
        ...
        props = _ref.props,
        plugin = _ref.plugin;
    vue__WEBPACK_IMPORTED_MODULE_3__["default"].use(plugin).use(_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__["default"]).component('Link', _inertiajs_inertia_vue__WEBPACK_IMPORTED_MODULE_0__.Link).component('Head', _inertiajs_inertia_vue__WEBPACK_IMPORTED_MODULE_0__.Head);
...
var render = function () {
  ...
  return _c(
    "div",
    [
      _c("Head", [_c("title", [_vm._v("Login")])]),
      _vm._v(" "),
      _c("main", [
        _c(
          "section",
          {
            staticClass: "bg-white p-8 rounded-xl max-w-md mx-auto mt-8 border",
          },
          [
            _c("h1", { staticClass: "text-3xl mb-6" }, [_vm._v("Login")]),
            _vm._v(" "),
            _c(
              "form",
              {
...
var render = function () {
  ...
  return _c(
    "div",
    [
      _c("Head", [_c("title", [_vm._v("Create User")])]),
      _vm._v(" "),
      _c("h1", { staticClass: "text-3xl" }, [_vm._v("Create New User")]),
      _vm._v(" "),
      _c(
        "form",
        {
          staticClass: "max-w-md mx-auto mt-8",
          on: {
            submit: function ($event) {
              $event.preventDefault()
              return _vm.submit.apply(null, arguments)
        ...
        [
          _c(
            "NavLink",
            {
              ...
              attrs: {
                href: "/users",
                active: _vm.$page.component === "Users/Index",
              },
            },
            [_vm._v("Users")]
          ),
